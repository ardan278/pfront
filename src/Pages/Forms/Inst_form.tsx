  ...
  return (
    <div className="page-container">
      ...
      <form className="installation-form">
        ...
        <div className="form-section">
          <h3 className="section-title">Cabin Dimensions</h3>
          <div className="form-grid">
            <div className="form-group">
        ...
        <div className="form-section">
          <h3 className="section-title">Shaft Dimensions</h3>
          <div className="form-grid">
            <div className="form-group">
        ...
        <div className="form-section">
          <h3 className="section-title">Installation Location</h3>
          <div className="form-grid">
            <div className="form-group full-width">
              <label htmlFor="addressInstall">Address of Install</label>
              <input type="text" id="addressInstall" className="form-input" />
            </div>
            <div className="form-group">
        ...
        <div className="form-actions">
          ...
          <button type="submit" className="form-button primary">Create Installation Contractor Form</button>
        </div>
      </form>
    </div>
  );
