  ...
  return (
    <div className="form-container">
      ...
      <div className="accordion-item">
        ...
        {openSection === 'form' && (
          <div className="accordion-content">
            <form>
              <div className="form-section-header">Equipment Information</div>
              ...
              <div className="form-group">
                <label htmlFor="drawingsGad">Drawings/GAD</label>
                <input type="file" id="drawingsGad" />
              </div>
              
              <div className="form-section-header">Cabin Dimensions</div>
              <div className="form-grid">
                <div className="form-group">
              ...
              <div className="form-section-header">Shaft Dimensions</div>
              <div className="form-grid">
                <div className="form-group">
              ...
              <div className="form-section-header">Installation Location</div>
              <div className="form-grid">
                <div className="form-group">
                  <label htmlFor="addressInstall">Address of Install</label>
                  <input type="text" id="addressInstall" />
                </div>
                <div className="form-group">
      ...
      <div className="button-container">
        <button type="submit" className="form-button">Create Installation Contractor Form</button>
      </div>
    </div>
  );
}